...
public class Servico_saida_negocial_Type  extends br.gov.caixa.sibar.SERVICO_SAIDA_TYPE  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Dados_saida_Type DADOS;
    ...
    public Servico_saida_negocial_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Dados_saida_Type DADOS) {
        super(
            HEADER,
            COD_RETORNO,
            ORIGEM_RETORNO,
     ...
     * @return DADOS
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Dados_saida_Type getDADOS() {
        return DADOS;
    }
     ...
     * @param DADOS
     */
    public void setDADOS(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Dados_saida_Type DADOS) {
        this.DADOS = DADOS;
    }
