...
public class Pagador_Type  implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Endereco_Type ENDERECO;
    ...
    public Pagador_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Endereco_Type ENDERECO) {
           this.CNPJ = CNPJ;
     ...
     * @return ENDERECO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Endereco_Type getENDERECO() {
        return ENDERECO;
    }
     ...
     * @param ENDERECO
     */
    public void setENDERECO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Endereco_Type ENDERECO) {
        this.ENDERECO = ENDERECO;
    }
