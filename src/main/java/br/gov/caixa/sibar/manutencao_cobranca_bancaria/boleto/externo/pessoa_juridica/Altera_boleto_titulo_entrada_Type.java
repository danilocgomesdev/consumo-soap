...
public class Altera_boleto_titulo_entrada_Type  implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_titulo_entrada_TypeFLAG_ACEITE FLAG_ACEITE;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_juros_mora_Type JUROS_MORA;

    private java.math.BigDecimal VALOR_ABATIMENTO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pos_vencimento_Type POS_VENCIMENTO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagador_Type PAGADOR;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_sacador_avalista_Type SACADOR_AVALISTA;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_multa_Type MULTA;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_desconto_Type[] DESCONTOS;

    private java.math.BigDecimal VALOR_IOF;

    private java.lang.String IDENTIFICACAO_EMPRESA;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_ficha_compensacao_Type FICHA_COMPENSACAO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_recibo_pagador_Type RECIBO_PAGADOR;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_Type PAGAMENTO;
    ...
    public Altera_boleto_titulo_entrada_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_titulo_entrada_TypeFLAG_ACEITE FLAG_ACEITE,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_juros_mora_Type JUROS_MORA,
           java.math.BigDecimal VALOR_ABATIMENTO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pos_vencimento_Type POS_VENCIMENTO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagador_Type PAGADOR,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_sacador_avalista_Type SACADOR_AVALISTA,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_multa_Type MULTA,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_desconto_Type[] DESCONTOS,
           java.math.BigDecimal VALOR_IOF,
           java.lang.String IDENTIFICACAO_EMPRESA,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_ficha_compensacao_Type FICHA_COMPENSACAO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_recibo_pagador_Type RECIBO_PAGADOR,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_Type PAGAMENTO) {
     ...
     * @return FLAG_ACEITE
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_titulo_entrada_TypeFLAG_ACEITE getFLAG_ACEITE() {
        return FLAG_ACEITE;
    }
     ...
     * @param FLAG_ACEITE
     */
    public void setFLAG_ACEITE(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_titulo_entrada_TypeFLAG_ACEITE FLAG_ACEITE) {
        this.FLAG_ACEITE = FLAG_ACEITE;
    }
     ...
     * @return JUROS_MORA
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_juros_mora_Type getJUROS_MORA() {
        return JUROS_MORA;
    }
     ...
     * @param JUROS_MORA
     */
    public void setJUROS_MORA(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_juros_mora_Type JUROS_MORA) {
        this.JUROS_MORA = JUROS_MORA;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pos_vencimento_Type getPOS_VENCIMENTO() {
        return POS_VENCIMENTO;
    }
     ...
     */
    public void setPOS_VENCIMENTO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pos_vencimento_Type POS_VENCIMENTO) {
        this.POS_VENCIMENTO = POS_VENCIMENTO;
    }
     ...
     * @return PAGADOR
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagador_Type getPAGADOR() {
        return PAGADOR;
    }
     ...
     * @param PAGADOR
     */
    public void setPAGADOR(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagador_Type PAGADOR) {
        this.PAGADOR = PAGADOR;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_sacador_avalista_Type getSACADOR_AVALISTA() {
        return SACADOR_AVALISTA;
    }
     ...
     */
    public void setSACADOR_AVALISTA(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_sacador_avalista_Type SACADOR_AVALISTA) {
        this.SACADOR_AVALISTA = SACADOR_AVALISTA;
    }
     ...
     * @return MULTA
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_multa_Type getMULTA() {
        return MULTA;
    }
     ...
     * @param MULTA
     */
    public void setMULTA(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_multa_Type MULTA) {
        this.MULTA = MULTA;
    }
     ...
     * @return DESCONTOS
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_desconto_Type[] getDESCONTOS() {
        return DESCONTOS;
    }
     ...
     * @param DESCONTOS
     */
    public void setDESCONTOS(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_desconto_Type[] DESCONTOS) {
        this.DESCONTOS = DESCONTOS;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_ficha_compensacao_Type getFICHA_COMPENSACAO() {
        return FICHA_COMPENSACAO;
    }
     ...
     */
    public void setFICHA_COMPENSACAO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_ficha_compensacao_Type FICHA_COMPENSACAO) {
        this.FICHA_COMPENSACAO = FICHA_COMPENSACAO;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_recibo_pagador_Type getRECIBO_PAGADOR() {
        return RECIBO_PAGADOR;
    }
     ...
     */
    public void setRECIBO_PAGADOR(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_recibo_pagador_Type RECIBO_PAGADOR) {
        this.RECIBO_PAGADOR = RECIBO_PAGADOR;
    }
     ...
     * @return PAGAMENTO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_Type getPAGAMENTO() {
        return PAGAMENTO;
    }
     ...
     * @param PAGAMENTO
     */
    public void setPAGAMENTO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_Type PAGAMENTO) {
        this.PAGAMENTO = PAGAMENTO;
    }
