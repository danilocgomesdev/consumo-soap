...
public class Dados_saida_Type  extends br.gov.caixa.sibar.DADOS_SAIDA_TYPE  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_saida_Type INCLUI_BOLETO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_saida_Type ALTERA_BOLETO;
    ...
    public Dados_saida_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_saida_Type INCLUI_BOLETO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_saida_Type ALTERA_BOLETO) {
        super(
            CONTROLE_NEGOCIAL,
            EXCECAO);
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_saida_Type getINCLUI_BOLETO() {
        return INCLUI_BOLETO;
    }
     ...
     * @param INCLUI_BOLETO
     */
    public void setINCLUI_BOLETO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_saida_Type INCLUI_BOLETO) {
        this.INCLUI_BOLETO = INCLUI_BOLETO;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_saida_Type getALTERA_BOLETO() {
        return ALTERA_BOLETO;
    }
     ...
     * @param ALTERA_BOLETO
     */
    public void setALTERA_BOLETO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_saida_Type ALTERA_BOLETO) {
        this.ALTERA_BOLETO = ALTERA_BOLETO;
    }
