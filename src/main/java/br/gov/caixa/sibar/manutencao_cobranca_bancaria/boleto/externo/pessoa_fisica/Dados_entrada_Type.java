...
public class Dados_entrada_Type  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_entrada_Type INCLUI_BOLETO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Baixa_boleto_entrada_Type BAIXA_BOLETO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_entrada_Type ALTERA_BOLETO;

    public Dados_entrada_Type() {
    }

    public Dados_entrada_Type(
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_entrada_Type INCLUI_BOLETO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Baixa_boleto_entrada_Type BAIXA_BOLETO,
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_entrada_Type ALTERA_BOLETO) {
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_entrada_Type getINCLUI_BOLETO() {
        return INCLUI_BOLETO;
    }
     ...
     * @param INCLUI_BOLETO
     */
    public void setINCLUI_BOLETO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Inclui_boleto_entrada_Type INCLUI_BOLETO) {
        this.INCLUI_BOLETO = INCLUI_BOLETO;
    }
     ...
     * @return BAIXA_BOLETO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Baixa_boleto_entrada_Type getBAIXA_BOLETO() {
        return BAIXA_BOLETO;
    }
     ...
     * @param BAIXA_BOLETO
     */
    public void setBAIXA_BOLETO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Baixa_boleto_entrada_Type BAIXA_BOLETO) {
        this.BAIXA_BOLETO = BAIXA_BOLETO;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_entrada_Type getALTERA_BOLETO() {
        return ALTERA_BOLETO;
    }
     ...
     * @param ALTERA_BOLETO
     */
    public void setALTERA_BOLETO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Altera_boleto_entrada_Type ALTERA_BOLETO) {
        this.ALTERA_BOLETO = ALTERA_BOLETO;
    }
