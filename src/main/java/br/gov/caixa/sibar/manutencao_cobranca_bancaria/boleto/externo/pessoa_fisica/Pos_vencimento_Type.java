...
public class Pos_vencimento_Type  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Pos_vencimento_TypeACAO ACAO;
    ...
    public Pos_vencimento_Type(
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Pos_vencimento_TypeACAO ACAO,
           short NUMERO_DIAS) {
           this.ACAO = ACAO;
     ...
     * @return ACAO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Pos_vencimento_TypeACAO getACAO() {
        return ACAO;
    }
     ...
     * @param ACAO
     */
    public void setACAO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Pos_vencimento_TypeACAO ACAO) {
        this.ACAO = ACAO;
    }
