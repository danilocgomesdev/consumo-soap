...
public class Inclui_boleto_entrada_Type  implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Titulo_entrada_Type TITULO;
    ...
    public Inclui_boleto_entrada_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Titulo_entrada_Type TITULO) {
     ...
     * @return TITULO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Titulo_entrada_Type getTITULO() {
        return TITULO;
    }
     ...
     * @param TITULO
     */
    public void setTITULO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Titulo_entrada_Type TITULO) {
        this.TITULO = TITULO;
    }
