...
public class Manutencao_cobranca_bancaria_ServiceLocator extends org.apache.axis.client.Service implements br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancaria_Service {
    ...
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancaria_PortType getmanutencao_cobranca_bancariaSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancaria_PortType getmanutencao_cobranca_bancariaSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancariaSOAPStub _stub = new br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancariaSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancaria_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancariaSOAPStub _stub = new br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Manutencao_cobranca_bancariaSOAPStub(new java.net.URL(manutencao_cobranca_bancariaSOAP_address), this);
                _stub.setPortName(getmanutencao_cobranca_bancariaSOAPWSDDServiceName());
                return _stub;
            }
        }
