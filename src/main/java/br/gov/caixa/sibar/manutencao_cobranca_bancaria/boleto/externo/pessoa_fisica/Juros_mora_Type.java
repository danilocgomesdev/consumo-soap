...
public class Juros_mora_Type  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Juros_mora_TypeTIPO TIPO;
    ...
    public Juros_mora_Type(
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Juros_mora_TypeTIPO TIPO,
           java.util.Date DATA,
     ...
     * @return TIPO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Juros_mora_TypeTIPO getTIPO() {
        return TIPO;
    }
     ...
     * @param TIPO
     */
    public void setTIPO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Juros_mora_TypeTIPO TIPO) {
        this.TIPO = TIPO;
    }
