...
public class Altera_boleto_pagamento_Type  implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_TypeTIPO TIPO;
    ...
    public Altera_boleto_pagamento_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_TypeTIPO TIPO,
     ...
     * @return TIPO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_TypeTIPO getTIPO() {
        return TIPO;
    }
     ...
     * @param TIPO
     */
    public void setTIPO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_juridica.Altera_boleto_pagamento_TypeTIPO TIPO) {
        this.TIPO = TIPO;
    }
