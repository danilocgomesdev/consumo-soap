...
public class Desconto_Type  implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Desconto_TypeTIPO TIPO;
    ...
    public Desconto_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Desconto_TypeTIPO TIPO) {
           this.DATA = DATA;
           this.VALOR = VALOR;
     ...
     * @return TIPO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Desconto_TypeTIPO getTIPO() {
        return TIPO;
    }
     ...
     * @param TIPO
     */
    public void setTIPO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Desconto_TypeTIPO TIPO) {
        this.TIPO = TIPO;
    }
