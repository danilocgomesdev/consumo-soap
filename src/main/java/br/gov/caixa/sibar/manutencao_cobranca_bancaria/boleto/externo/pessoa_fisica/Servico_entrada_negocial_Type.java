...
public class Servico_entrada_negocial_Type  extends br.gov.caixa.sibar.SERVICO_ENTRADA_TYPE  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Dados_entrada_Type DADOS;
    ...
    public Servico_entrada_negocial_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Dados_entrada_Type DADOS) {
        super(
            HEADER);
        this.DADOS = DADOS;
    }
     ...
     * @return DADOS
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Dados_entrada_Type getDADOS() {
        return DADOS;
    }
     ...
     * @param DADOS
     */
    public void setDADOS(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.pessoa_fisica.Dados_entrada_Type DADOS) {
        this.DADOS = DADOS;
    }
