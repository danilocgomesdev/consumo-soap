/**
 * Consulta_boleto_pagamento_Type.java
 *
...
public class Consulta_boleto_pagamento_Type  implements java.io.Serializable {
    private short QUANTIDADE_PERMITIDA;

    private br.gov.caixa.sibar.consulta_cobranca_bancaria.boleto.Consulta_boleto_pagamento_TypeTIPO TIPO;
    ...
    public Consulta_boleto_pagamento_Type() {
    }

    public Consulta_boleto_pagamento_Type(
           short QUANTIDADE_PERMITIDA,
           br.gov.caixa.sibar.consulta_cobranca_bancaria.boleto.Consulta_boleto_pagamento_TypeTIPO TIPO,
    ...
    /**
     * Gets the QUANTIDADE_PERMITIDA value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    /**
     * Sets the QUANTIDADE_PERMITIDA value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    /**
     * Gets the TIPO value for this Consulta_boleto_pagamento_Type.
     * 
     * @return TIPO
     */
    public br.gov.caixa.sibar.consulta_cobranca_bancaria.boleto.Consulta_boleto_pagamento_TypeTIPO getTIPO() {
        return TIPO;
    }


    /**
     * Sets the TIPO value for this Consulta_boleto_pagamento_Type.
     * 
     * @param TIPO
     */
    public void setTIPO(br.gov.caixa.sibar.consulta_cobranca_bancaria.boleto.Consulta_boleto_pagamento_TypeTIPO TIPO) {
        this.TIPO = TIPO;
    }


    /**
     * Gets the VALOR_MINIMO value for this Consulta_boleto_pagamento_Type.
     * 
     * @return VALOR_MINIMO
     */
    ...
    /**
     * Sets the VALOR_MINIMO value for this Consulta_boleto_pagamento_Type.
     * 
     * @param VALOR_MINIMO
     */
    ...
    /**
     * Gets the VALOR_MAXIMO value for this Consulta_boleto_pagamento_Type.
     * 
     * @return VALOR_MAXIMO
     */
    ...
    /**
     * Sets the VALOR_MAXIMO value for this Consulta_boleto_pagamento_Type.
     * 
     * @param VALOR_MAXIMO
     */
    ...
    /**
     * Gets the PERCENTUAL_MINIMO value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    /**
     * Sets the PERCENTUAL_MINIMO value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    /**
     * Gets the PERCENTUAL_MAXIMO value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    /**
     * Sets the PERCENTUAL_MAXIMO value for this Consulta_boleto_pagamento_Type.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Consulta_boleto_pagamento_Type)) return false;
        Consulta_boleto_pagamento_Type other = (Consulta_boleto_pagamento_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Consulta_boleto_pagamento_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caixa.gov.br/sibar/consulta_cobranca_bancaria/boleto", "consulta_boleto_pagamento_Type"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://caixa.gov.br/sibar/consulta_cobranca_bancaria/boleto", ">consulta_boleto_pagamento_Type>TIPO"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
