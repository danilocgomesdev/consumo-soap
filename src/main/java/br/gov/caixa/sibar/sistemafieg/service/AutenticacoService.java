...
/**
 * Gera a autenticação para o WS da caixa
 *
 * @author Matheus Calaça
 */
public class AutenticacoService {
    /**
     * recebe os valores para retornar um hash
     * para o WS da caixa
     *
    ...
    /**
     * configura o hash para ser encriptografado
     *
     * @param codBeneficiario
     * @param data
     * @param valor
     * @param nossoNumero
     * @param cnpjCpf
     * @return String para montar o hash
     */
