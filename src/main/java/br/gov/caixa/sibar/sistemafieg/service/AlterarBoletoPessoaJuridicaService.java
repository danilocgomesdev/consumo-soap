 ...
 */
public class AlterarBoletoPessoaJuridicaService {
     ...
     * @return
     */
    public Servico_saida_negocial_Type alteraBoletoPessoaJuridica(DadosDto dto) {
        try {
...
//        }
        ...
        String razao_social = dadosEntradaType.getALTERA_BOLETO().getTITULO().getPAGADOR().getRAZAO_SOCIAL();
        if (razao_social.length() > 40 && razao_social != null) {
            dadosEntradaType.getALTERA_BOLETO().getTITULO().getPAGADOR().setRAZAO_SOCIAL(razao_social.substring(0, 40));
        }
